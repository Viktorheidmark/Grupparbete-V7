...
function addContentDefine() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (FsProvider_1.FSProvider.checkExist('src/entity/ContentDefine.ts')) {
            const confirm = yield vscode.window.showQuickPick([constant_1.Confirmation.No, constant_1.Confirmation.Yes], { placeHolder: 'Module CONTENT DEFINE is already exist. You want to REPLACE?' });
