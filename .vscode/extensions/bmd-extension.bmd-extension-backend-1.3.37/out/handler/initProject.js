...
function initProject() {
    return __awaiter(this, void 0, void 0, function* () {
        if (FsProvider_1.FSProvider.checkExist('src')) {
            const confirm = yield vscode.window.showQuickPick([constant_1.Confirmation.No, constant_1.Confirmation.Yes], { placeHolder: 'Already exist project. You want to replace it??? ' });
        ...
        function initDeploy(from, to, params) {
            FsProvider_1.FSProvider.copyAndReplaceFile(from, to, [
